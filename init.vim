" let g:python_host_prog='~/.pyenv/versions/3.8.1/bin/python'
" TODO remember to fix the path below
...
let g:LanguageClient_serverCommands = {
    ...
    \ 'tf': ['~/.vscode*/extensions/mauve.terraform-1.4.0/lspbin/terraform-lsp']
    \ }
